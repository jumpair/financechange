...
}, _base = require("base64"), _siteinfo = require("../siteinfo"), _siteinfo2 = _interopRequireDefault(_siteinfo), _md = require("md5"), _md2 = _interopRequireDefault(_md);
...
function getSign(e, t, n) {
    ...
    d < i.length - 1 && (c += "&"));
    return o = r(c + (n = n || _siteinfo2.default.token));
}
...
util.base64_encode = function(e) {
    ...
    e[2] && (n += "do=" + e[2] + "&")), t && "object" === (void 0 === t ? "undefined" : _typeof(t))) for (var a in t) a && t.hasOwnProperty(params) && t[a] && (n += a + "=" + t[a] + "&");
    return n;
    ...
    var n = wx.getStorageSync("sessionid"), i = "entry/wxapp/" + a.url;
    ...
    var o = getSign(i, a.data);
    if (o && (i = i + "&sign=" + o), !i) return !1;
    if (wx.showNavigationBarLoading(), a.showLoading && util.showLoading(), a.cachetime) {
        var s = t(i), u = wx.getStorageSync(s), c = Date.parse(new Date());
        if (u && u.data) {
            if (u.expire > c) return a.complete && "function" == typeof a.complete && a.complete(u), 
            a.success && "function" == typeof a.success && a.success(u), wx.hideLoading(), wx.hideNavigationBarLoading(), 
            !0;
    ...
    wx.request((_defineProperty(e = {
        ...
        if (wx.hideNavigationBarLoading(), a.showLoading && wx.hideLoading(), e.data.errno && -1 != e.data.errno) {
        ...
        } else if (a.success && "function" == typeof a.success && (getApp().config.debug_success && console.log(e.data), 
        a.success(e.data.data)), a.cachetime) {
            var n = {
                data: e.data,
                expire: c + 1e3 * a.cachetime
            };
            wx.setStorageSync(s, n);
        }
        ...
        wx.login({
            success: function(e) {
                util.request({
                    ...
                    cachetime: 0,
                    success: function(e) {
                        e.data.errno || (t.sessionid = e.data.data.sessionid, wx.getUserInfo({
                            success: function(e) {
                                t.wxInfo = e.userInfo, wx.setStorageSync("userInfo", t), util.request({
                                    ...
                                    cachetime: 0,
                                    success: function(e) {
                                        e.data.errno || (t.memberInfo = e.data.data), "function" == typeof n && n(t);
                                    }
                                });
                            },
                            fail: function() {
    ...
    t.sessionid ? wx.checkSession({
        ...
        fail: function() {
            t.sessionid = "", console.log("relogin"), e();
        }
    }) : e();
