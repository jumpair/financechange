...
(0, _baseComponent.default)({
    ...
    observers: _defineProperty({}, "inputValue, max, activeColor", function(r, e, n) {
        ...
        }, []), i = r.toString().split("."), o = 1 === i.length ? [ i[0], 0 ] : i;
        this.setData({
            stars: t,
            colors: a,
            cutIndex: 1 * o[0],
    ...
    methods: {
        ...
        setValue: function(e) {
            var t = this.data.max, a = e <= 0 ? 0 : t < e ? t : e;
            this.updated(a);
        },
        updateHalfStarValue: function(i, o, l) {
            var u = this, e = this.data.prefixCls;
            wx.createSelectorQuery().in(this).selectAll(".".concat(e, "__star")).boundingClientRect(function(e) {
                if (!e.filter(function(e) {
                    return !e;
                }).length) {
                    var t = e[i], a = t.left, r = t.width, n = o - a < r / 2 ? i + .5 : i + 1;
                    l.call(u, n, i);
                }
            }).exec();
        },
        onTap: function(e) {
            var r = this, t = e.currentTarget.dataset.index, a = this.data, n = a.inputValue, i = a.disabled, o = a.allowHalf, l = a.allowClear;
            if (!i) if (o) this.updateHalfStarValue(t, e.detail.x, function(e, t) {
                var a = l && e === n;
                r.onChange(a ? 0 : e, t);
            }); else {
                var u = t + 1, s = l && u === n;
        ...
        onTouchMove: function(e) {
            var s = this, t = this.data, a = t.disabled, c = t.allowHalf, r = t.allowTouchMove;
            if (!a && r) {
                var f = e.changedTouches[0].pageX, n = this.data.prefixCls;
                wx.createSelectorQuery().in(this).selectAll(".".concat(n, "__star")).boundingClientRect(function(e) {
                    if (!e.filter(function(e) {
                        return !e;
                    }).length) {
                        var t = e[0], a = t.left, r = t.width, n = e.map(function(e) {
                            return e.width;
                        }).reduce(function(e, t) {
                            return e + t;
                        }), i = f - a, o = Math.ceil(i / r);
                        if (0 < i && i < n) {
                            var l = o - 1;
                            if (c) {
                                var u = e[l];
    ...
    attached: function() {
        var e = this.data, t = e.defaultValue, a = e.value, r = e.controlled ? a : t;
        this.setValue(r);
    }
});