...
var getTouchPoints = function(t, e) {
    var s = 1 < arguments.length && void 0 !== e ? e : 0, o = t.touches, n = t.changedTouches, i = o && 0 < o.length, r = n && 0 < n.length, a = !i && r ? n[s] : i ? o[s] : t;
    return {
        x: a.pageX,
        y: a.pageY
    };
...
var getPointsDistance = function(t, e) {
    var s = Math.abs(t.x - e.x), o = Math.abs(t.y - e.y);
