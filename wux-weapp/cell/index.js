...
(0, _baseComponent.default)({
    ...
    computed: {
        classes: [ "prefixCls, hoverClass, isLast, isLink, disabled", function(e, t, n, a, i) {
            var r;
            return {
                wrap: (0, _classNames2.default)(e, (_defineProperty(r = {}, "".concat(e, "--last"), n), 
                _defineProperty(r, "".concat(e, "--access"), a), _defineProperty(r, "".concat(e, "--disabled"), i), 
                r)),
                hd: "".concat(e, "__hd"),
    ...
    methods: {
        ...
        linkTo: function() {
            var e = this.data, t = e.url, n = e.isLink, a = e.openType, i = e.delta;
